    ...
    <Card className="w-64 shadow-lg">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-sm font-semibold">ESP32 Monitor</CardTitle>
          {isConnected ? (
          ...
          <>
            ...
            {data.humidity !== undefined && (
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold">{data.humidity.toFixed(1)}%</span>
              </div>
            )}
            {data.batteryLevel !== undefined && (
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="font-semibold">{data.batteryLevel.toFixed(0)}%</span>
              </div>
            )}
            {data.deviceId && (
